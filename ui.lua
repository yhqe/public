...
local settings = {
    folder_name = "cathaxx"; -- stupid shit
...
local themes = {
    ["Default"] = {
        ["Accent"] = Color3.fromRGB(110, 144, 255),
...
local themeobjects = {}
local library = {theme = table.clone(themes.Default),currentcolor = nil, folder = "cathaxx", flags = {}, open = true, mousestate = services.InputService.MouseIconEnabled, cursor = nil, holder = nil, connections = {}, notifications = {}};
...
function library.createkeybindlist() -- ctrl c + ctrl v 
    ...
    -- drawings
    local list_outline = utility.create("Square", {Visible = true, Transparency = 1, Theme = "Window Outline Background", Size = UDim2.new(0, 150, 0, 15), Position = UDim2.new(0, 10, 0.4, 0), Thickness = 1, Filled = true, ZIndex = 100}) do
